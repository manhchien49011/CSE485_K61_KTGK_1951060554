<?php
  if(isset($_POST['btnSave'])){
    ...
    $sql = "INSERT INTO blood_recipient( reci_name, reci_age, reci_bgroup, reci_bqnty, reci_sex, reci_reg_date, reci_phno)
  ...
  <body>
      ...
      <main class="mt-4">
        <div class="container">
            <div class="row">
              <div class="col-md-12">
                <h2>Thêm người đăng kí nhận máu </h2>
                <form action="them.php" method="post">
                  ...
                  <div class="row mb-3">
                    <label for="txtNhomMau" class="col-sm-2 col-form-label">Nhóm máu</label>
                    <div class="col-sm-10">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="txtSoMauNhan" name="txtSoMauNhan">
                    </div>
                  </div>
                  <div class="row mb-3">
                    <label for="datetimepickerInline" class="col-sm-2 col-form-label">Giới tính</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="txtGioiTinh" name="txtGioiTinh">
                    </div>
                  </div>
                  <div class="row mb-3">
                    <label for="datetimepickerInline" class="col-sm-2 col-form-label">Ngày đăng kí nhận</label>
